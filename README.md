...
3/10/30 secondi) su rete giù, timeout, errori HTTP, risposta vuota o non JSON.
...
più di tre giorni (`TOLLERANZA`), così un intoppo passeggero del sito non manda
un allarme inutile ma un guasto vero sì.
